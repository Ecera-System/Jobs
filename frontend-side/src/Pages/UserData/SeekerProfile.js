                                ...
                                <ul>
                                    ...
                                    <li className='mt-2 text-lg font-medium'>
                                        <div className='flex gap-5'>
                                            <div>
                                                <label htmlFor='startDate' className='font-medium text-base'>Start date</label>
                                            ...
                                            </div>
                                            {
                                                studying ? '' :
                                                    <div>
                                                        <label htmlFor='endDate' className='font-medium text-base'>End date</label>
                            ...
                            <ul>
                                ...
                                </li>
                                {
                                    eduEndDate ?
                                        ...
                                        :
                                        <li className='mt-2 text-base font-medium'>{eduStudying}</li>
                                }
                            </ul>
                    }
                </div>
                    ...
                    {addJobExp ?
                        <div className='w-full bg-white sm:px-10 px-5 sm:py-8 py-5 h-max mt-8 mb-10 rounded-xl border shadow-lg'>
                            ...
                            <form>
                                <div>
                                    <div>
                                        <label htmlFor='jobTitle' className='font-medium text-base'>Job title<span className='text-orange-600 ml-1'>*</span></label>
                                    ...
                                    <div className='mt-5'>
                                        <label htmlFor='companyName' className='font-medium text-base'>Company name<span className='text-orange-600 ml-1'>*</span></label>
                                    ...
                                    <div className='flex sm:justify-between sm:gap-5 sm:flex-row flex-col'>
                                        <div className='mt-5'>
                                            <label htmlFor='startDate' className='font-medium text-base'>Start date<span className='text-orange-600 ml-1'>*</span></label>
                                        ...
                                        </div>
                                        {
                                            currentWork ? '' :
                                                <div className='mt-5'>
                                                    <label htmlFor='endDate' className='font-medium text-base'>End date<span className='text-orange-600 ml-1'>*</span></label>
                                    ...
                                    <div className='mt-5'>
                                        <label htmlFor='responsibilities' className='font-medium text-base'>Responsibilities</label>
                            ...
                            <div className='mt-6 flex justify-between items-center'>
                                <button className='btn btn-outline btn-accent sm:px-10 px-6 capitalize text-base text-white h-0 sm:min-h-12 min-h-8' type="submit">Save</button>
                                <button onClick={() => setAddJobExp(!addJobExp)} className='btn btn-link sm:px-10 capitalize text-base text-accent hover:no-underline hover:text-primary h-0 min-h-8'>Cancel</button>
                            </div>
                        </div>
                        :
                        <ul>
                            ...
                            </li>
                            {
                                exEndDate ?
                                    ...
                                    :
                                    <li className='mt-2 text-base font-medium'>{exWorking}</li>
                            }
